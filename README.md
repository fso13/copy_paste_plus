...
- Избранное (звёздочка) с комментариями, pin, папками и тегами
...
Закладки со звёздочкой: pin сверху, папки, теги и комментарии — быстрый доступ без хаоса.
...
| Навигация по списку | `↑` / `↓` |
| В избранное | Клик по ★ |
| Закрепить / теги / папка | ⋮ → Pin / теги / папка |
